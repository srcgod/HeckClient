...
/**
 * Calling these outside of {@link net.kyc.client.impl.event.render.RenderWorldEvent} will blow everything up
 */
public class RenderBuffers {
    ...
    public static class Buffer {
        ...
        /**
         * render in immediate mode if we're calling from outside of {@link net.kyc.client.impl.event.render.RenderWorldEvent}
         */
        public void end() {
            if (!isSetup) draw();
        }
