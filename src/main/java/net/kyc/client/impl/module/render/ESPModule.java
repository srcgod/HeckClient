...
import net.kyc.client.impl.event.EntityOutlineEvent;
...
public class ESPModule extends ToggleModule {
    ...
    Config<Color> playersColorConfig = new ColorConfig("PlayersColor", "The render color for players", new Color(255, 0, 0 , 60), false, () -> playersConfig.getValue());
