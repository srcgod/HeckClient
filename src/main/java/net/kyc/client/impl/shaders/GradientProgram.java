package net.kyc.client.impl.shaders;

import net.minecraft.util.math.Vec2f;
import net.kyc.client.api.render.shader.Program;
import net.kyc.client.api.render.shader.Shader;
import net.kyc.client.api.render.shader.Uniform;
